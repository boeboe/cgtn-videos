...
class SpecialParser(object):
    ...
    def parse_specials(year):
        ...
        try:
            request = requests.get(SpecialParser.BASE_URL.format(year), timeout=REQUEST_TIMEOUT)
            ...
            for special_item in special_item_list:
                ...
                specials.append(Special(key=key, name=name, url=url, img_url=img_url))
        except:
            pass
